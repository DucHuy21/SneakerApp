...
public class SneakerAdidasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phanloai = getIntent().getIntExtra("phanloai", 2);
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adidasAdapter.notifyItemInserted(sanPhamMoiList.size() - 1);
            }
        });
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adidasAdapter.notifyItemRemoved(sanPhamMoiList.size());
                page = page + 1;
                getData(page);
    ...
    private void getData(int page) {
        compositeDisposable.add(apiSanPham.getSanPham(page, phanloai)
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()) {
                                if (adidasAdapter == null) {
                                    ...
                                    adidasAdapter = new AdidasAdapter(getApplicationContext(), sanPhamMoiList);
                                    recyclerView.setAdapter(adidasAdapter);
                                } else {
                                    ...
                                    adidasAdapter.notifyItemRangeInserted(vitri, soluongadd);
                                }
                            } else {
    ...
    private void AnhXa() {
        toolbar = findViewById(R.id.toolBar_adidas);
        recyclerView = findViewById(R.id.rcv_adidas);
